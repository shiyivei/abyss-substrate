...
pub use frame_support::{
	traits::{ConstU128, ConstU8, KeyOwnerProofSystem, Randomness, StorageInfo},
	weights::{
		constants::{
...
parameter_types! {
	pub const GetNativeCurrencyId: CurrencyId = CurrencyId::Token(TokenSymbol::POV);
}
...
impl DEXIncentives<AccountId, CurrencyId, Balance> for MockDEXIncentives {
	fn do_deposit_dex_share(
		...
		// Tokens::reserves(lp_currency_id, who, amount)
		Ok(())
	}
